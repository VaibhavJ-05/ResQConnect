...
export const sosService = {
  ...
  getGovSos: async () => {
    const response = await api.get('/sos/gov');
    return response.data;
  },
  assignNgo: async (id, ngoId) => {
    const response = await api.put(`/sos/gov/${id}/assign-ngo`, { ngoId });
    return response.data;
  },
  rejectSos: async (id) => {
    const response = await api.put(`/sos/gov/${id}/reject`);
    return response.data;
  },
  resolveSos: async (id) => {
    const response = await api.put(`/sos/gov/${id}/resolve`);
    return response.data;
  },
  // NGO Workflow
  getNgoSos: async () => {
    const response = await api.get('/sos/ngo');
    return response.data;
  },
  assignVolunteer: async (id, volunteerId) => {
    const response = await api.put(`/sos/ngo/${id}/assign-volunteer`, { volunteerId });
    return response.data;
  },
  verifySosCompletion: async (id) => {
    const response = await api.put(`/sos/ngo/${id}/verify`);
    return response.data;
  },
  // Volunteer Workflow
  getVolunteerTasks: async () => {
    const response = await api.get('/sos/volunteer/tasks');
    return response.data;
  },
  updateVolunteerTaskStatus: async (id, status) => {
    const response = await api.put(`/sos/volunteer/tasks/${id}/status`, { status });
    return response.data;
  },
  uploadVolunteerTaskProof: async (id, proofData) => {
    const response = await api.post(`/sos/volunteer/tasks/${id}/proof`, proofData);
    return response.data;
  },
};
...
export const donationService = {
  ...
  verifyPayment: async (verificationData) => {
    const response = await api.post('/donations/verify-payment', verificationData);
    return response.data;
  },
